...
class _MyTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    this.widget.borderColor ??= MyColors.secondaryColor;
    this.widget.focusedBorderColor ??= MyColors.borderActiveColor;
    return CustomContainer(
      ...
      child: TextFormField(
        ...
        style: this.widget.textStyle != null
            ...
            : TextStyle(color: MyColors.textSeconday),
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: this.widget.showLeadingWidget
              ? Column(
